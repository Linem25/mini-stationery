    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Bút bi Thiên Long TL-027", 3500m, 120 },
                    { 2, 1, "Bút highlight Stabilo Boss", 22000m, 0 },
                    { 3, 2, "Vở kẻ ngang Campus 200 trang", 18000m, 4 },
                    { 4, 3, "Kéo văn phòng Deli", 15000m, 30 }
                });
